...
const experiments: Experiment[] = [
  ...
  },
  {
    ...
    difficulty: 'Başlangıç',
    difficultyEn: 'Beginner',
    description: 'Eğik düzlemde hareket ve kuvvet analizi',
    descriptionEn: 'Motion and force analysis on an inclined plane',
    route: '/experiments/mechanics/inclined-plane',
  },
  {
    id: '5',
